...
namespace Core.Shared
{
    ...
    public partial class STWordInsert
    {
        public static void Debug(SGSymbol symbol, Int32 index, Int32 count, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(STWord) + ' ' + "::" + ' ' + nameof(STWordInsert) + ' ' + '{',
                        String.Empty + '.' + "debug",
