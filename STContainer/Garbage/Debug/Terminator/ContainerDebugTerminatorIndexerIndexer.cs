...
namespace Core.Shared
{
    ...
    {
        public static void Debug_ContainerTerminatorIndexerIndexer(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back__ANSWER_BOOLEAN__, Int32 rebase, Int32 indexer_START, Int32 indexer_END, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(STContainer) + ' ' + "::" + ' ' + nameof(Debug_ContainerTerminatorIndexerIndexer) + ' ' + '{',
                        ...
                        String.Empty + '\t' + '~' + "05" + ' ' + nameof(indexer_START) + ':' + ' ' + indexer_START,
                        String.Empty + '\t' + '~' + "06" + ' ' + nameof(indexer_END) + ':' + ' ' + indexer_END,
