...
namespace Core.Shared
{
    ...
    {
        public static void Debug_ContainerTerminatorPrimarySecondary(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back__ANSWER_BOOLEAN__, Int32 rebase, Int32 primary, Int32 secondary, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(STContainer) + ' ' + "::" + ' ' + nameof(Debug_ContainerTerminatorPrimarySecondary) + ' ' + '{',
                        ...
                        String.Empty + '\t' + '~' + "05" + ' ' + nameof(primary) + ':' + ' ' + primary,
                        String.Empty + '\t' + '~' + "06" + ' ' + nameof(secondary) + ':' + ' ' + secondary,
