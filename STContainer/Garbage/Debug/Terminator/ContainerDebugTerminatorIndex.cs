...
namespace Core.Shared
{
    ...
    {
        public static void Debug_ContainerTerminatorIndex(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back__ANSWER_BOOLEAN__, Int32 rebase, Int32 index, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(STContainer) + ' ' + "::" + ' ' + nameof(Debug_ContainerTerminatorIndex) + ' ' + '{',
                        ...
                        String.Empty + '\t' + '~' + "06" + ' ' + nameof(backward) + ':' + ' ' + backward,
