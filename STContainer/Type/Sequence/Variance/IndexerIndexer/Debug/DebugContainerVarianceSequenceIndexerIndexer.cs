...
namespace Core.Shared
{
    ...
    public partial class STContainerVarianceSequenceIndexerIndexer
    {
        public static void Debug(SGDelimiter delimiter, Int32 rebase, Int32 indexer_START, Int32 indexer_END, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                var message = String.Join('\n'.ToString(), new String[] {
                    String.Empty + nameof(STContainer) + ' ' + "::" + ' ' + nameof(STContainerVarianceSequenceIndexerIndexer) + ' ' + '{',
                    String.Empty + '.' + "debug",
