...
namespace Core.Shared
{
    ...
    public partial class STContainerTerminatorSequenceIndexCount
    {
        public static void Debug(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back_, Int32 rebase, Int32 index, Int32 count, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
