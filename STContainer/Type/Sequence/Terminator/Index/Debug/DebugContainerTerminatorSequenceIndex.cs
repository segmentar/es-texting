...
namespace Core.Shared
{
    ...
    public partial class STContainerTerminatorSequenceIndex
    {
        public static void Debug(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back_, Int32 rebase, Int32 index, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
