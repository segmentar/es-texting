...
namespace Core.Shared
{
    ...
    public partial class STContainerTerminatorSequenceIndexerIndexer
    {
        public static void Debug(SGDelimiter delimiter_VALUE, SGDelimiter delimiter_TERMINATOR, Boolean _front_back_, Int32 rebase, Int32 indexer_START, Int32 indexer_END, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
