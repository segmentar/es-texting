...
namespace Core.Shared
{
    ...
    public partial class STContainerOccurrenceSequenceIndexerIndexer
    {
        public static void Debug(SGSymbol symbol, Int32 rebase, Int32 indexer_START, Int32 indexer_END, Boolean backward, SGText text, Boolean debug)
        {
            goto descriptor;
