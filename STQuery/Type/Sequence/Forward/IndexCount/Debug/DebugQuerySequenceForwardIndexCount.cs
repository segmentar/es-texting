...
namespace Core.Shared
{
    ...
    public partial class STQuerySequenceForwardIndexCount
    {
        public static void Debug(SGSymbol symbol, Int32 index, Int32 count, Boolean next, SGText text, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(STSearch) + ' ' + "::" + ' ' + nameof(STQuerySequenceForwardIndexCount) + ' ' + '{',
                        String.Empty + '.' + "debug",
